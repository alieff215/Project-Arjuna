        ...
        <div class="form-card">
          ...
          <form action="<?= base_url('admin/departemen/tambahDepartemenPost'); ?>" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" id="departemen" class="form-control <?= invalidFeedback('departemen') ? 'is-invalid' : ''; ?>" name="departemen" placeholder="X, XI, XII" value="<?= old('departemen') ?>" required>
