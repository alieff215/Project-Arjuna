...
<div class="content" id="pageAbsensiAdmin">
   ...
   <div class="container-fluid">
      ...
      <!-- ====== DATA ABSEN SUPERVISOR ====== -->
      <div class="u-card">
         <div class="u-head">
            <div>
               <h4 class="u-title"><i class="material-icons" style="color:var(--success)">assignment_turned_in</i> Absen Supervisor</h4>
               <p class="u-sub">Total Supervisor: <span style="background: var(--success); color: white; padding: 2px 8px; border-radius: 8px; font-weight: 700;"><?= $total_admin; ?></span> | <?= date('d M Y H:i'); ?></p>
            </div>
