               ...
               <div class="card-body mx-5 my-3">
                  ...
                  <form action="<?= base_url('admin/karyawan/create'); ?>" method="post">
                     ...
                     <div class="form-group mt-4">
                        ...
                        <input type="date" id="tanggal_join" name="tanggal_join" class="form-control <?= $validation->getError('tanggal_join') ? 'is-invalid' : ''; ?>" value="<?= old('tanggal_join') ?? $oldInput['tanggal_join'] ?? '' ?>">
                        <div class="invalid-feedback">
